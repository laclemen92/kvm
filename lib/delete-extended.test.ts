...
Deno.test("Delete Comprehensive Coverage", async (t) => {
  ...
  await t.step(
    "should delete entity without atomic operations (simple path)",
    async () => {
  ...
  await t.step(
    "should handle manyToMany relation without through table",
    async () => {
  ...
  await t.step(
    "should handle unknown relation type in cascade delete",
    async () => {
  ...
  await t.step(
    "should test cascadeDeleteChildren function directly",
    async () => {
  ...
  await t.step(
    "should handle cascadeDeleteChildren with error scenario",
    async () => {
      ...
      // Create parent record
      const parentValue = {
        id: "error_parent_cascade_1",
        name: "Error Parent",
      };
      await kv.set(
        ["error_parent_cascade", "error_parent_cascade_1"],
        parentValue,
      );
  ...
  await t.step(
    "should handle manyToMany cascade delete error gracefully",
    async () => {
