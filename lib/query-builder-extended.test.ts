...
import { KVMQueryError, KVMNotFoundError } from "./errors.ts";
...
Deno.test("KVMQueryBuilder - Comprehensive Coverage", async (t) => {
  ...
  await t.step("should validate negative limit and offset", async () => {
    ...
    try {
      ...
      assertEquals((error as Error).message.includes("Limit must be non-negative"), true);
    }
    ...
    try {
      ...
      assertEquals((error as Error).message.includes("Offset must be non-negative"), true);
    }
  });
  ...
  await t.step("should execute query with filtering", async () => {
    ...
    // Create test data
    const users = [
      { id: "1", name: "John", age: 25, email: "john@test.com", isActive: true },
      { id: "2", name: "Jane", age: 30, email: "jane@test.com", isActive: true },
      { id: "3", name: "Bob", age: 20, email: "bob@test.com", isActive: false },
      { id: "4", name: "Alice", age: 35, email: "alice@test.com", isActive: true },
    ];
  ...
  await t.step("should execute query with complex conditions", async () => {
    ...
    // Create test data
    const users = [
      { id: "1", name: "John Smith", age: 25, email: "john@test.com", isActive: true },
      { id: "2", name: "Jane Doe", age: 30, email: "jane@test.com", isActive: true },
      { id: "3", name: "Bob Johnson", age: 20, email: "bob@test.com", isActive: false },
      { id: "4", name: "Alice Brown", age: 35, email: "alice@test.com", isActive: true },
    ];
  ...
  await t.step("should handle findOne", async () => {
    ...
    // Create test data
    await User.create({ id: "1", name: "John", age: 25, email: "john@test.com", isActive: true });
    await User.create({ id: "2", name: "Jane", age: 30, email: "jane@test.com", isActive: true });
  ...
  await t.step("should test all comparison operators", async () => {
    ...
    // Create test data
    const users = [
      { id: "1", name: "Alice", age: 25, email: "alice@test.com", isActive: true, tags: ["admin", "user"] },
      { id: "2", name: "Bob", age: 30, email: "bob@test.com", isActive: false, tags: ["user"] },
      { id: "3", name: "Charlie", age: 20, email: "charlie@test.com", isActive: true },
      { id: "4", name: "Unknown", age: 35, email: "unknown@test.com", isActive: true },
    ];
  ...
  await t.step("should handle error conditions", async () => {
    ...
    await User.create({ id: "error-test-1", name: "Test", age: 25, email: "test@test.com", isActive: true });
  ...
  await t.step("should handle sorting edge cases", async () => {
    ...
    const users = [
      { id: "sort-1", name: "John", age: 25, email: "a@test.com", isActive: true },
      { id: "sort-2", name: "Jane", age: 25, email: "b@test.com", isActive: true },
      { id: "sort-3", name: "Bob", age: 25, email: "c@test.com", isActive: true },
    ];
