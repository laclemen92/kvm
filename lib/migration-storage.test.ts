...
Deno.test("MigrationStorage", async (t) => {
  ...
  await t.step(
    "should not re-initialize if version already exists",
    async () => {
      const kv = await Deno.openKv(":memory:");
      const storage = new MigrationStorage(kv);
  ...
  await t.step(
    "should handle version mismatch in apply migration",
    async () => {
      const kv = await Deno.openKv(":memory:");
      const storage = new MigrationStorage(kv);
  ...
  await t.step(
    "should validate migration integrity - valid chain",
    async () => {
      const kv = await Deno.openKv(":memory:");
      const storage = new MigrationStorage(kv);
  ...
  await t.step(
    "should validate migration integrity - version mismatch",
    async () => {
      const kv = await Deno.openKv(":memory:");
      const storage = new MigrationStorage(kv);
  ...
  await t.step(
    "should validate migration integrity - no migrations but version set",
    async () => {
      const kv = await Deno.openKv(":memory:");
      const storage = new MigrationStorage(kv);
  ...
  await t.step(
    "should validate migration integrity - gap in sequence",
    async () => {
      const kv = await Deno.openKv(":memory:");
      const storage = new MigrationStorage(kv);
